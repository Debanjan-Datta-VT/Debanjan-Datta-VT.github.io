    ...
    <div class="col-md-9">
      <div class="card h-100">
        <div class="card-body">
          ...
          <ul class="mt-3">
            <li><i class="fas fa-arrow-right text-success me-2"></i>The research advances our understanding of temporal knowledge systems and their applications in enterprise environments.</li>
            <li><i class="fas fa-arrow-right text-success me-2"></i>A real world use case for long-term temporal memory is an analyst exploring a corpus of documents relating to financial documents, where relationships between entities can evolve through time.</li>
            <li><i class="fas fa-arrow-right text-success me-2"></i>Constructing a chain of events relating different entities through time is a non-trivial problem.</li>
          </ul>
        </div>
      </div>
    </div>
